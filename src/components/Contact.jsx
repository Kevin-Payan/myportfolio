...
const ContactSection = () => {
  return (
    <section className="bg-custom-background max-w-4xl mx-auto text-center px-4 sm:px-8 py-12">
      <h1 className='flex text-2xl text-custom-text-primary mb-8 font-medium'>CONTACT</h1>
        ...
        <div className="text-left max-w-sm mx-auto">
          ...
          <ul className="space-y-4">
            <li className="flex items-center gap-3">
              <a href="mailto:kevinpn@hotmail.com" className="flex items-center gap-2 transition-transform transform hover:scale-110 group" target="_blank">
            ...
            <li className="flex items-center gap-3">
              <a href="https://www.linkedin.com/in/kevinpayan/" className="flex items-center gap-2 transition-transform transform hover:scale-110 group" target="_blank">
            ...
            <li className="flex items-center gap-3">
              <a href="https://github.com/Kevin-Payan" className="flex items-center gap-2 transition-transform transform hover:scale-110 group" target="_blank">
