...
const About = () => {
  return (
    <section className="w-full px-4 sm:px-8 py-12 max-w-4xl mx-auto">
      <h1 className="text-2xl text-custom-text-primary mb-8 font-medium">
        ABOUT ME
      </h1>
      <h2 className="text-xl font-semibold text-custom-text-accent mb-2">
        Behind the code
      </h2>
      <p className="text-base leading-relaxed text-custom-text mb-8">
        Passionate about crafting elegant, efficient solutions to complex
        problems. I enjoy building APIs, managing databases, and setting up
        cloud infrastructure—but I also enjoy making sure the frontend feels
        smooth and intuitive. I'm especially interested in how artificial
        intelligence can unlock new possibilities across the stack—from smarter
        automation to more adaptive systems. Always learning, always
        building—I'm driven by curiosity, creativity, and the goal of delivering
        meaningful impact through technology.
      </p>

      <h2 className="text-xl font-semibold text-custom-text-accent mb-4">
        Skills
      </h2>
